...
\item Apply the above mentioned model using \textit{Life} or Cellular Automata to predict growth of informal settlements in the South African context.
\end{itemize}
...
\end{table}
\noindent The approach for this research study will be a combination of Scrum, Agile and Waterfall. As it is perfect for incremental changes made to the model that will be created.
\section{Project management}
\subsection{Project Plan}
Self management will be key in this research project and all its endeavours.\\
...
\item 9 November: Submission of complete documentation 
\end{itemize}
