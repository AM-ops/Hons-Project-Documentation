...
When an artefact is developed it can take on different methodologies in its approach. Below is a table that has a few such approaches. The table is a modified example from another sources\cite{ieee,sdlc}.
\begin{table}[H]
\centering
\begin{tabular}{@{}ll@{}}
\toprule
...
The only legal and ethical implications for this research is in the form of third party data access. To account for this the ethics form is attached in Appendix \ref{AppendixA}.
