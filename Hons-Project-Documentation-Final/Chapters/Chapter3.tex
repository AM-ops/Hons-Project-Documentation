...
\end{figure}
Once the coordinates were acquired the Folium interactive map was created of the \textit{Melusi} area. This is shown below. The surrounding suburbs and regions can also be seen. The url link for this can be accessed
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{Figures/Chapter3/Folium}
