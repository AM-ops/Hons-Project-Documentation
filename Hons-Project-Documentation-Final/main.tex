...
\textsc{\Large Honours Research}\\[0.5cm] % Thesis type
...
\large \textit{A research submitted in fulfilment of the requirements\\ for the degree of \degreename} % University requirement text
\textit{in the}\\[0.4cm]
...
\noindent Signed:\hspace*{30pt}\texttt{A Muhammad}\\
\rule[0.5em]{25em}{0.5pt} % This prints a line for the signature
 
\noindent Date: \hspace*{30pt}\texttt{\today} \\
...
Informal settlements in the South African context are complex social and economical structures. They differ in spatial location, size, and function. Urban development occurs hand-in-hand with informal settlements where one can not exist without the other. The relationship between them can be understood if all the factors involved are known. Predicting the growth of informal settlements will benefit both parties involved in this relationship. This study embarks on predicting informal settlement growth using the Cellular Automata model. This is successful done with an accuracy that can be said to be "Substantial".\\
\textit{\textbf{Keywords:} Cellular Automata, GIS, Image Processing, Informal settlements, Modelling}
\end{abstract}

\begin{extraAbstract}
\addchaptertocentry{\abstractnameextra} % Add the abstract to the table of contents
%The Thesis Abstract is written here (and usually kept to just this page). The page is kept centered vertically so can expand into the blank space above the title too\ldots
Informele nedersettings in die Suid-Afrikaanse konteks is komplekse sosiale en ekonomiese strukture. Hulle verskil in ruimtelike ligging, grootte en funksie. Stedelike ontwikkeling vind hand-aan-hand plaas met informele nedersettings waar die een nie sonder die ander kan bestaan nie. Die verhouding tussen hulle kan verstaan word as al die betrokke faktore bekend is. Om die groei van informele nedersettings te voorspel sal baat by beide partye wat by hierdie verhouding betrokke is. Hierdie studie begin met die voorspelling van informele nedersettingsgroei deur die Sellulêre outomatiese-model te gebruik. Dit word suksesvol gedoen met 'n akkuraatheid wat gesê kan word dat dit "wesenlik" is.\\
\textit{\textbf{Sleutelwoorde:} Beeldverwerking, GIS, Informele nedersettings, Modellering, Sellulêre outomatiese}
\end{extraAbstract}
...
\textbf{GIF} & \textbf{G}raphics \textbf{I}nterchange \textbf{F}ormat\\
